...
export function About() {
  ...
  return (
    <section
      id="about"
      className="relative bg-linear-to-b from-[#0f163f] via-[#0a0e27] to-[#060a1b] overflow-hidden py-16 sm:py-20 md:py-24 lg:py-32 2xl:py-40 px-3 sm:px-4 md:px-6 lg:px-8 2xl:px-28"
    >
      ...
      <div className="absolute bottom-0 left-1/4 w-64 h-64 sm:w-80 sm:h-80 md:w-96 md:h-96 lg:w-96 lg:h-96 bg-[#4984c8]/5 rounded-full blur-3xl -z-10" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 md:gap-12 lg:gap-16 items-start">
            <motion.div variants={itemVariants} className="space-y-4 sm:space-y-5 md:space-y-6">
              <div className="inline-flex">
                <span className="text-xs sm:text-sm font-semibold uppercase tracking-widest text-[#35a7ff] bg-[#35a7ff]/10 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full border border-[#35a7ff]/20">
                  Who we are
                </span>
              </div>
            ...
            <motion.div
              ...
              className="space-y-3 sm:space-y-4 md:space-y-5 text-white/70 leading-relaxed"
            >
          ...
          >
            ...
            >
              ...
              <motion.div
                ...
                className="absolute -bottom-4 sm:-bottom-6 -right-4 sm:-right-6 bg-[#162a5b]/40 backdrop-blur-md border border-[#35a7ff]/30 rounded-lg sm:rounded-xl p-2 sm:p-3 md:p-4 shadow-xl hidden md:block"
              >
